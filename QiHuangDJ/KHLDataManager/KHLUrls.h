...
#define KHLUrlRegister @"app_register.php"

#pragma mark - 2.2 （2.2）登录
#define KHLUrlLogin @"app_login.php"
...
#define KHLUrlPersonalInformationModify @"app_editinfo.php"
...
#define KHLUrlLiveDetailAcquire @"app_zhibo.php"
...
#define KHLUrlUnsubscribeCategory @"app_quxiaodingyue.php"
...
#pragma mark - ?.? （2.11）举报
#define KHLUrlReport @"app_jubao.php"

#pragma mark - ?.? （2.10）评论
#define KHLUrlCommentReply @"app_pinglun.php"
